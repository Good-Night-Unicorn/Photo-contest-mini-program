    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="项目简介" prop="xiangmujianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="项目简介"
                  v-model="ruleForm.xiangmujianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangmujianjie" label="项目简介" prop="xiangmujianjie">
                    <span>{{ruleForm.xiangmujianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmuleixing = true;
          ...
          if(o=='xiangmujianjie'){
            this.ruleForm.xiangmujianjie = obj[o];
	    this.ro.xiangmujianjie = true;
            continue;
          }
          if(o=='fengmian'){
	...
	this.ruleForm.xiangmuneirong = this.ruleForm.xiangmuneirong.replace(reg,'../../../djangov8117/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
