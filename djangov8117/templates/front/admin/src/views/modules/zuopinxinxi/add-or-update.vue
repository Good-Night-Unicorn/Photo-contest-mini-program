<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.zuopintupian" label="作品图片" prop="zuopintupian">
          <file-upload
          tip="点击上传作品图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuopintupian" label="作品图片" prop="zuopintupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zuopintupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="提交日期" prop="tijiaoriqi">
          <el-input v-model="ruleForm.tijiaoriqi" 
              placeholder="提交日期" clearable  :readonly="ro.tijiaoriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="提交日期" prop="tijiaoriqi">
              <el-input v-model="ruleForm.tijiaoriqi" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="评论日期" prop="pinglunriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.pinglunriqi" 
                type="date"
                placeholder="评论日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pinglunriqi" label="评论日期" prop="pinglunriqi">
              <el-input v-model="ruleForm.pinglunriqi" 
                placeholder="评论日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.pinglunriqi = this.getCurDate()
